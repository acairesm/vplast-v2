...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vplast Embalagens" },
      { name: "description", content: "Fitas adesivas e soluções para embalagens." },
      { name: "author", content: "Vplast Embalagens" },
      { property: "og:title", content: "Vplast Embalagens" },
      { property: "og:description", content: "Fitas adesivas e soluções para embalagens." },
